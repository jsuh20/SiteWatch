/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: df51ac7fac508496d52e8c9f7f10baf1)
...
declare namespace Cloudflare {
	...
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
		AGENT: DurableObjectNamespace<import("./src/index").AgentDurableObject>;
		WORKFLOW: Workflow<Parameters<import("./src/index").AgentWorkflow['run']>[0]['payload']>;
	}
}
